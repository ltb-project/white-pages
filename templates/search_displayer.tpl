<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <div class="input-group">
            ...
            <span class="input-group-text btn-info"><input type="checkbox" name="{$item}match" value="exact" data-toggle="popover" data-content="{$msg_exactmatch}"></span>
            <span class="input-group-text btn-danger"><input type="checkbox" name="{$item}negates" value="true" data-toggle="popover" data-content="{$msg_negates}"></span>
            {elseif $type eq 'list'}
            <select class="form-control" id="{$item}" name="{$item}" placeholder="{$label}">
                <option></option>
